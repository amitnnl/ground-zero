...
import { Mail, Globe, PhoneCall, Send, ShieldCheck, CheckCircle2 } from "lucide-react";
    ...
    <footer className="bg-[#0B0F19] text-slate-300 mt-16 pb-16 md:pb-0 border-t-4 border-[#E11D48]">
      ...
      <div className="container mx-auto px-4 py-12 max-w-[1440px]">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 sm:gap-10 mb-10">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-4">
              ...
              <span className="font-black text-lg text-white tracking-tight">
                GROUND ZERO <span className="text-[#E11D48]">NEWS</span>
              </span>
            </Link>
            <p className="text-xs leading-relaxed text-slate-400 mb-4">
              साउथ हरियाणा का अग्रणी डिजिटल मीडिया नेटवर्क। निर्भीक पत्रकारिता, ज़मीनी रिपोर्टिंग और जनसरोकारों की विश्वसनीय आवाज़।
            </p>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2.5 mb-4">
              ...
              <a
                href="https://x.com/GROUND_O_NEWS"
                target="_blank"
                rel="noopener noreferrer"
                title="X (Twitter)"
              ...
              <a
                href="https://www.facebook.com/share/1JSz58duru/"
                target="_blank"
                rel="noopener noreferrer"
                title="Facebook"
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-400">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:gznarnaul@gmail.com" className="hover:text-white">
                  gznarnaul@gmail.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Globe size={13} className="text-[#E11D48]" />
                <a href="https://groundzeronews.com" className="hover:text-white">
                  groundzeronews.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <PhoneCall size={13} className="text-[#E11D48]" />
                <span>साउथ हरियाणा समाचार डेस्क</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800/80 pt-7 text-xs text-slate-500 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p>© 2026 Ground Zero News. All rights reserved.</p>
          <p className="text-slate-400">
            South Haryana Leading Digital News Network | Battle For Truth
          </p>
        </div>
      </div>
    </footer>
